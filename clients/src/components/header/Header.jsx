    ...
    <div>
      <nav className="fixed top-0 left-0 right-0 z-50 w-full mx-auto bg-white shadow-md md:w-full mt-100 md:pb-1">
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl p-3 mx-auto md:p-4 sm:pt-0">
          ...
          <div className="mb-0 relative  md:block hidden md:w-80">
            <div className="flex items-center justify-center md:w-80">
              <input
                style={{ border: '1px solid green' }}
                type="text"
                className="overflow-hidden  shadow-lg font-serif lg:w-full text-sm rounded-full block w-full py-2 pl-10 pr-2 bg-transparent border-red-600 duration-75 placeholder-gray-400 focus:outline-none  text-gray-500"
                required
                placeholder="Search Services..."
                onChange={(e) => setKeyWord(e.target.value)}
              />
              {/* <MdLocationPin className="inline-block" /> */}
              <div onClick={() => navigate(`/all/services?${keyword}`)} style={{ borderTopLeftRadius: '50%', borderBottomLeftRadius: '50%' }} className=" border-r absolute left-0 ml-[1px] -mt-[1px] cursor-pointer border-1  bg-transparent  p-2">
      ...
      >
        ...
        <div className="mb-0 relative md:hidden mt-4 md:w-80">
